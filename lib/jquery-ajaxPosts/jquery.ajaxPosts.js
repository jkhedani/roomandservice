  ...
  */
  ...
  $('.jquery-ajax-get-posts').on('click', function() {
    ...
    jquery_ajax_get_posts( post_type, post_count, post_category, post_offset ).done(function( response ) {
      ...
      var total_article_count = $('.jquery-ajax-post-container article').length; console.log(total_article_count);
      var total_post_count    = $('.jquery-ajax-get-posts').data('total-post-count'); console.log(total_post_count);
      if( total_article_count <= total_post_count ) {
        $('.jquery-ajax-get-posts').hide();
      }
    });
